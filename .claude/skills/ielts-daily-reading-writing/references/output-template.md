...
If using the bundled `.claude/skills/ielts-daily-reading-writing/scripts/export_daily_pack.py`, create a JSON file with these keys:
- `level`
- `topic`
- `day`
- `practice_markdown`
...
When compiling review packs, save the payload as a JSON file with these keys and pass it to `.claude/skills/ielts-daily-reading-writing/scripts/export_review_pack.py`:
