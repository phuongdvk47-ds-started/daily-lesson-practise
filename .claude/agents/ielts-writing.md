...
name: ielts-writing
description: >-
  IELTS daily-pack sub-agent. Generate IELTS-aligned writing tasks (topic
  relevant, with SVG/markdown visuals and spacing cues) tied to grammar targets
  and lesson vocabulary for the resolved CEFR level. Returns a writing JSON
  section. Use when the orchestrator needs the Writing section.
tools: ["Read"]
---
