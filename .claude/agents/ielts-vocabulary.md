...
description: >-
  IELTS daily-pack sub-agent. Extract and define vocabulary from the reading
  passage, build Quizlet sections, recycled vocabulary table, and randomized
  Vocab Checker data for the resolved CEFR level. Returns a vocabulary JSON
  section. Use when the orchestrator needs the Vocabulary section.
tools: ["Read"]
---
