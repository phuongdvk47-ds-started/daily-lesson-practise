...
- `topic`: defaults via `.claude/skills/ielts-daily-reading-writing/scripts/select_daily_inputs.py` or a level-appropriate topic from `.claude/skills/ielts-daily-reading-writing/references/topic-bank.md`.
...
3. **Load pedagogical constraints** from `.claude/skills/ielts-daily-reading-writing/references/pedagogical-constraints.md`.
4. **Consult History**:
...
9. **Call Reading Agent**:
   - Load `.claude/skills/ielts-daily-reading-writing/references/deep-question-blueprint.md` and `.claude/skills/ielts-daily-reading-writing/references/deep-reading-generation-rules.md`.
   ...
   - Reject Reading output before QC if it violates blueprint fields, deep-reading ratios, printed-passage evidence, or the gates in `.claude/skills/ielts-daily-reading-writing/references/regeneration-quality-gates.md`.
...
17. **Call Grammar Agent**:
    - Load `.claude/skills/ielts-daily-reading-writing/references/deep-question-blueprint.md` and `.claude/skills/ielts-daily-reading-writing/references/deep-grammar-generation-rules.md`.
    ...
    - Reject Grammar output before QC if it violates blueprint fields, level-specific deep-grammar ratios, one-answer logic, meaning preservation, or the gates in `.claude/skills/ielts-daily-reading-writing/references/regeneration-quality-gates.md`.
...
23. **Call Answer Agent**:
    - Load `.claude/skills/ielts-daily-reading-writing/references/deep-answer-key-rules.md`.
...
24. **Call Quality Control Agent**:
    - Load `.claude/skills/ielts-daily-reading-writing/references/regeneration-quality-gates.md`.
...
27. **Export PDFs**:
    - Run `.claude/skills/ielts-daily-reading-writing/scripts/validate_lesson_json.py`. If validation passes, run `.claude/skills/ielts-daily-reading-writing/scripts/export_daily_pack.py` to compile.
28. **Post-Render QC**:
    - Run `.claude/skills/ielts-daily-reading-writing/scripts/validate_rendered_pdf.py` for the Practice PDF and use `.claude/skills/ielts-daily-reading-writing/references/post-render-pdf-qc.md` as the checklist for every exported PDF.
...
2. **Aggregate Inputs**:
   - Rerun `.claude/skills/ielts-daily-reading-writing/scripts/prepare_review_inputs.py` to extract all grammar targets and vocabulary items from the target days.
...
4. **Assemble Review JSON** according to `.claude/skills/ielts-daily-reading-writing/references/output-schema.md` and run Quality Control.
...
7. **Validate Review JSON** via `.claude/skills/ielts-daily-reading-writing/scripts/validate_lesson_json.py`.
8. **Export Review PDFs** via `.claude/skills/ielts-daily-reading-writing/scripts/export_review_pack.py`.
